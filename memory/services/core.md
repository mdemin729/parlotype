...
- [[decisions/_index|ADR-043]] Cloud speech providers v1 (`SpeechEngine.OpenAiCompatible`/`XaiGrok`, `ISecretStore`, cloud settings keys, transcribe-only capability arms)
