...
description: Use when creating or editing notes in the memory/ Obsidian vault. Covers required YAML frontmatter, wikilinks, headings, callouts, tags, and embed conventions used across the Parlotype vault.
---
